...
public class AdapterMyProfileChild extends RecyclerView.Adapter<AdapterMyProfileChild.ViewHolder> {

    private List<ModelMyProfileChild> mOptionList;
    private OnOptionClickListener mListener;

    public AdapterMyProfileChild(List<ModelMyProfileChild> optionList, OnOptionClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ModelMyProfileChild option = mOptionList.get(position);
    ...
    public interface OnOptionClickListener {
        void onOptionClick(int childPosition);
    }
}
