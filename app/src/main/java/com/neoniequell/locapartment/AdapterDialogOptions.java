...
public class AdapterDialogOptions extends RecyclerView.Adapter<AdapterDialogOptions.ViewHolder> {
    ...
    public AdapterDialogOptions(Context context, List<ModelOption> optionList,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        int paddingTopBottom = UtilPixelToDp.marginInDp(mContext, 12);
        int paddingStartEnd = UtilPixelToDp.marginInDp(mContext, 24);
        holder.mBinding.llParent.setPadding(paddingStartEnd, paddingTopBottom,
                paddingStartEnd, paddingTopBottom);
